...
@JS('hookupPlotlyRelayout')
external void _hookupPlotlyRelayout(
  domName,
  Function jsFunction,
);

@JS('unHookPlotlyRelayout')
external void _unHookPlotlyRelayout(
  domName,
  Function jsFunction,
);
...
@JS('hookupPlotlyEvent')
external void _hookupPlotlyEvent(
  String domName,
  String hookupEventName,
  Function jsFunction,
);
...
@anonymous
class PrependData {
  external factory PrependData({
    List<List<num>> y,
  });

  external List<List<num>> get y;
}

@JS()
@anonymous
class UpdateData {
  external factory UpdateData({
    List<String> yaxis,
    String hoverinfo,
  });

  external List<String> get yaxis;
  external String get hoverinfo;

  external set yaxis(List<String> value);
...
class Data {
  ...
  external String get xaxis;
  external String get hovertemplate;

  // Setters.
  external set visible(String value);
  external set hoverinfo(String value);

  external set yaxis(String value);
  external set xaxis(String value);

  external set x(List value);
  external set y(List value);
  external set hovertemplate(String value);
}
...
class Grid {
  ...
  external int get pattern;
  external int get roworder;
}
...
class AxisLayout {
  ...
  external bool get showspikes;
  external String get spikemode;
  external String get spikedash;
  external String get spikecolor;
  external String get spikesnap;
  external String get spikethicknes;

  external set showspikes(bool value);
  external set range(List<num> value);
}
...
@JS()
@anonymous
class RangeSliderYAxis {
  external factory RangeSliderYAxis({
    String rangemode,
    List<num> range,
  });
...
class RangeSlider {
  ...
  external String get rangemode;
  external RangeSliderYAxis get yaxis;
  external Font get tickfont;
}
...
@anonymous
class UpdateEvent {
  external AxisRange get range;
}

@JS()
@anonymous
class AxisRange {
  external List<double> get x;
  external List<double> get y;
}
...
void hookupPlotlyRelayout(
  String domName,
  Function f,
) {
  _hookupPlotlyRelayout(domName, allowInterop(f));
}

void unHookPlotlyRelayout(
  String domName,
  Function f,
) {
  _unHookPlotlyRelayout(domName, allowInterop(f));
}

void hookupPlotlyEvent(
  String domName,
  String hookupEventName,
  Function f,
) {
  _hookupPlotlyEvent(domName, hookupEventName, allowInterop(f));
}
